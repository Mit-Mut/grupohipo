odoo.define('theme_plenus.ecommerce', function(require) {
	...
	$(function(){
		...
		$('#wrapwrap .dropdown > a').click(function(){return false;});
		    $("#wrapwrap  .dropdown").hover(            
	            function() {
	                $('.dropdown-menu', this).stop( true, true ).fadeIn("slow");
	                $(this).toggleClass('open');
	                  $('.dropdown-menu', this).stop( true, true ).addClass('dropdown_animation');
	            },
	            function() {
	            	
	                $('.dropdown-menu', this).stop( true, true ).removeClass('dropdown_animation').fadeOut(500);
